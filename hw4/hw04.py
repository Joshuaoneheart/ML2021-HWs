...
class Classifier(nn.Module):
  def __init__(self, d_model=256, n_spks=600, dropout=0.1):
    ...
    """
    self.encoder = ConformerEncoder(input_dim = d_model, num_attention_heads = 2, encoder_dim = d_model, num_layers=2, attention_dropout_p = 0.3, feed_forward_dropout_p = 0.3)
